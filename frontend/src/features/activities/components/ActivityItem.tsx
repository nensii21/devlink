...
const getActivityIcon = (type: Activity["activity_type"]) => {
  switch (type) {
    case "user_registered": return <UserPlus className="w-4 h-4 text-green-500" />;
    case "profile_updated": return <Edit3 className="w-4 h-4 text-blue-500" />;
    case "project_created": return <FolderPlus className="w-4 h-4 text-indigo-500" />;
    case "project_updated": return <Edit3 className="w-4 h-4 text-blue-400" />;
    case "project_archived": return <Archive className="w-4 h-4 text-gray-500" />;
    case "project_milestone": return <Flag className="w-4 h-4 text-yellow-500" />;
    case "application_submitted": return <Send className="w-4 h-4 text-purple-500" />;
    ...
    case "team_invitation": return <Mail className="w-4 h-4 text-blue-500" />;
    case "repository_connected": return <Github className="w-4 h-4 text-gray-700" />;
    case "followed_user": return <UserPlus className="w-4 h-4 text-pink-500" />;
    case "message_sent": return <MessageSquare className="w-4 h-4 text-blue-500" />;
    case "comment_created": return <MessageCircle className="w-4 h-4 text-indigo-500" />;
    case "discussion_created": return <MessageCircle className="w-4 h-4 text-purple-500" />;
    case "organization_created": return <Users className="w-4 h-4 text-orange-500" />;

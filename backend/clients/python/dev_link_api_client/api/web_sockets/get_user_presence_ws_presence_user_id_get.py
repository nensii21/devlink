...
from ...models.get_user_presence_ws_presence_user_id_get_response_get_user_presence_ws_presence_user_id_get import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/ws/presence/{user_id}".format(
...
def sync(
    ...
    *,
    ...
    Returns:
        GetUserPresenceWsPresenceUserIdGetResponseGetUserPresenceWsPresenceUserIdGet | HTTPValidationError
    """

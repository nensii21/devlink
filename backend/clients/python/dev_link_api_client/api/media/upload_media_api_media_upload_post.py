...
def _get_kwargs(
    *,
    body: BodyUploadMediaApiMediaUploadPost,
) -> dict[str, Any]:
...
) -> HTTPValidationError | MediaUploadResponse | None:
    if response.status_code == 201:
        response_201 = MediaUploadResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | MediaUploadResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | MediaUploadResponse
    """

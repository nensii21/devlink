...
T = TypeVar(
    "T",
    bound="InviteUserApiV1ProjectsProjectIdInviteUserIdPostResponseInviteUserApiV1ProjectsProjectIdInviteUserIdPost",
)


@_attrs_define
class InviteUserApiV1ProjectsProjectIdInviteUserIdPostResponseInviteUserApiV1ProjectsProjectIdInviteUserIdPost:
    """ """

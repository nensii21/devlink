...
from ..models.hackathon_status import HackathonStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="HackathonResponse")
...
class HackathonResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = HackathonStatus(d.pop("status"))
        ...
        hackathon_response.additional_properties = d

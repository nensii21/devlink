...
T = TypeVar(
    "T",
    bound="GetAnalyticsDashboardApiSearchAnalyticsDashboardGetResponseGetAnalyticsDashboardApiSearchAnalyticsDashboardGet",
)


@_attrs_define
class GetAnalyticsDashboardApiSearchAnalyticsDashboardGetResponseGetAnalyticsDashboardApiSearchAnalyticsDashboardGet:
    """ """

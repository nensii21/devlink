...
def upgrade() -> None:
    ...
    sa.Column('provider', sa.Enum('GITHUB', 'GITLAB', 'BITBUCKET', name='repositoryprovider'), nullable=False),
    ...
    op.create_index(op.f('ix_repositories_connected_by'), 'repositories', ['connected_by'], unique=False)

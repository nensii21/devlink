...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_activities_builder_flare_id'), 'activities', ['builder_flare_id'], unique=False)
    ...
    op.create_index(op.f('ix_activities_repository_id'), 'activities', ['repository_id'], unique=False)
    ...
    op.create_index(op.f('ix_builder_flares_created_at'), 'builder_flares', ['created_at'], unique=False)
    op.create_index(op.f('ix_builder_flares_featured'), 'builder_flares', ['featured'], unique=False)
    op.create_index(op.f('ix_builder_flares_status'), 'builder_flares', ['status'], unique=False)

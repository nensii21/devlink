...
def upgrade() -> None:
    ...
    sa.Column('stage', sa.Enum('IDEA', 'VALIDATION', 'MVP', 'BETA', 'PRODUCTION', name='projectstage'), nullable=False),
    sa.Column('visibility', sa.Enum('PUBLIC', 'PRIVATE', name='projectvisibility'), nullable=False),
